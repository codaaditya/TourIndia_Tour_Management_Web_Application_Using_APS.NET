...
<div class="container mt-4">
    ...
    <asp:GridView ID="gvBookingReport" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Package Image">
                <ItemTemplate>
                    <asp:Image ID="imgPackage" runat="server" ImageUrl='<%# ResolveUrl("~/admin/" + Eval("PackageImage")) %>' 
                        AlternateText="Package Image" Width="100px" Height="100px" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
...
<div class="text-center">
    <!--<asp:Button ID="Button1" runat="server" Text="Download PDF" CssClass="btn btn-success"/>   -->        
