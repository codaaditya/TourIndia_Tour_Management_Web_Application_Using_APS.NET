...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="package-details-container">
        <asp:DataList ID="dlTourPackage" runat="server" RepeatLayout="Table" OnItemCommand="dlTourPackage_ItemCommand" OnSelectedIndexChanged="dlTourPackage_SelectedIndexChanged">
            <ItemTemplate>
                <div class="package-box">
                    <!-- Tour Image -->
                    <div class="package-image">
                         <img src='<%# ResolveUrl("~/admin/" + Eval("ImagePath")) %>' alt="Tour Image" />
                    </div>
                   ...
                   <asp:LinkButton ID="addtocart" runat="server" CssClass="add-btn" CommandName="AddToCart"
