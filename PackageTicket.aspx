<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PackageTicket.aspx.cs" Inherits="WebApplication11.PackageTicket" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <form id="form1" runat="server">
        <div style="width:600px;margin:50px auto;padding:20px;border:1px solid #ccc;">
            <h2>Tour Ticket</h2>
            <asp:Image ID="imgPackage" runat="server" Width="300px" /><br /><br />
            <p><strong>Name:</strong> <asp:Label ID="lblFullName" runat="server" /></p>
            ...
            <p><strong>Tour Date:</strong> <asp:Label ID="lblTourDate" runat="server" /></p>
            <p><strong>No. of Persons:</strong> <asp:Label ID="lblNoOfPerson" runat="server" /></p>

            <asp:Button ID="btnDownload" runat="server" Text="Download Ticket" OnClick="btnDownload_Click" />
        </div>
    </form>
</asp:Content>
